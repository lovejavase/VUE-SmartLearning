<template>
	...
	<view class="intelligent">
		...
		<view class="knowledge">
			...
			<scroll-view class="navscroll" scroll-x>
				<view class="content" v-for="(i, index) in 3" :key="i">
					<image src="@/static/image/knowledge1.png" class="image" />
					<view class="text">
		...
		<view class="famous">
			...
			<scroll-view class="navscroll" scroll-x>
				<view class="item" v-for="(item, index) in famousImg" :key="index">
					<image src="@/static/image/famous1.png" alt="" />
				</view>
			</scroll-view>
		</view>
		<!-- 智能分类 -->
